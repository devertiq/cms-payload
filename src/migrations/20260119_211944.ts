...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "pages_blocks_blocks_list" (
  ...
  ALTER TABLE "pages_blocks_blocks_list" ADD CONSTRAINT "pages_blocks_blocks_list_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_blocks_list_order_idx" ON "pages_blocks_blocks_list" USING btree ("_order");
  CREATE INDEX "pages_blocks_blocks_list_parent_id_idx" ON "pages_blocks_blocks_list" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_blocks_list_path_idx" ON "pages_blocks_blocks_list" USING btree ("_path");
  CREATE INDEX "pages_blocks_blocks_list_identifier_idx" ON "pages_blocks_blocks_list" USING btree ("identifier");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   DROP TABLE "pages_blocks_blocks_list" CASCADE;
